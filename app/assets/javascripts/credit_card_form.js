...
// function to handle form submition and intercept default event
  submitHandler = function(event){
    ...
    if(Stripe){
      ...
      show_error("Failed to laod credit card processing functionality. Please reload the page.")
    };
...
// Initiate submit handler listener for any form with class cc_form
  $(".cc_form").on("sumbit", submitHandler);
...
// function to call plan cahnge handler so that the plan is set correctly in the drop down when the page loads
